...
public class Main {
	...
	public static void main(String[] args) {
		...
		// bean.getClass().getAnnotation(RPCService.class);
		//
		// System.out.println(annotation.serviceName());
		// // System.out.println(annotation.value());
		//
		IDemoService bean2 = context.getBean("IDemoService2", IDemoService.class);
		bean2.say("Tom");
		...
		// IDemoService proxy =
		// ServiceProxy.newProxy().newServiceProxy(DemoServiceImpl.class);
		// proxy.say("Tom");

		System.out.println("".getClass().asSubclass(String.class));
